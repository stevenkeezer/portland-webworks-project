  ...
  return (
    ...
    >
      <input
        ...
        name="search"
        id="search"
        className="transition-color block w-full px-4 text-base shadow-inner duration-200 placeholder:italic placeholder:text-gray-700 focus:border-blue-500 focus:border-opacity-60 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 sm:mr-3 sm:flex-1"
